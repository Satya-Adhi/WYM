                ...
                if (isset($error_up)) {
                  ...
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h5><i class="icon fas fa-ban"></i>'.$error_up.'</h5></div>';
                        ...
                        echo form_open_multipart('film/edit/'. $film->id_film ) ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="id_type" class="form-control" id="type">
                                            <option value="<?= $film->id_type ?>"><?= $film->type_film ?></option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="id_genre" class="form-control" id="genre">
                                            <option value="<?= $film->id_genre ?>"><?= $film->nama_genre ?></option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="id_country" class="form-control" id="country">
                                            <option value="<?= $film->id_country ?>"><?= $film->nama_country ?></option>
                            ...
                            <div class="form-group">
                                <img src="<?= base_url('assets/film/'. $film->gambar)?>" id="gambar_load"
                                    class="img-fluid">
                            </div>
